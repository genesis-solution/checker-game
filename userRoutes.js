...
const { login, register, result, logout, generateJWTtoken, getUserInfo, getBotInfo, setLog, getCurrentTime, getposition } = require('./route/controllers');
...
gameRoutes.post('/getposition', getposition);
